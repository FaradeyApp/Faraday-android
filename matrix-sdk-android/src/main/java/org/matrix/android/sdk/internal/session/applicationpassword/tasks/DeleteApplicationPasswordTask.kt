...
internal interface DeleteApplicationPasswordTask : Task<Unit, Boolean> {
}

internal class DefaultDeleteApplicationPasswordTask @Inject constructor(
        private val applicationPasswordAPI: ApplicationPasswordAPI,
        private val globalErrorReceiver: GlobalErrorReceiver
) : DeleteApplicationPasswordTask {
    override suspend fun execute(params: Unit): Boolean {
        val result = try {
            executeRequest(globalErrorReceiver) {
                applicationPasswordAPI.deleteApplicationPassword()
            }.status
