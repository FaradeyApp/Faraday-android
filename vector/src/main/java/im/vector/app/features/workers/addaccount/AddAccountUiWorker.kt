...
package im.vector.app.features.workers.addaccount
...
class AddAccountUiWorker(private val activity: FragmentActivity) {
    ...
    fun perform() {
        ...
        if (session.cannotLogoutSafely()) {
            ...
            MaterialAlertDialogBuilder(activity)
                    ...
                    .setMessage(R.string.action_add_new_account_confirmation_simple)
                    .setPositiveButton(R.string.action_add_new_account) { _, _ ->
                        doSignOut()
                    }
